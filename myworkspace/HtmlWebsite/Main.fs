    ...
    let Page2 =
        Skin.WithTemplate "Title of Page2" <| fun ctx ->
            [
                ...
                Div [Id "content"]
                Script [Src "http://fb.me/JSXTransformer-0.11.1.js"]
                Script [Src "http://code.jquery.com/jquery-1.10.0.min.js"]
                Script [Src "~/../Scripts/HtmlWebSite/helloReact.js";Attributes.Type "text/jsx"] //type "text/jsx"
            ]
